...
var appendElem = function appendElem(elem, cont) {
  if (cont) cont.appendChild(elem);
}; // Set active class


var setActive = function setActive(elems, childElems) {
  [].forEach.call(elems, function (item, index) {
    item.addEventListener('click', function (e) {
      var target = e.target;
      if (target === item) return;
      [].forEach.call(childElems, function (childItem, index) {
...
var headerTeleport = function headerTeleport() {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
...
var initBurgerMenu = function initBurgerMenu() {
  burgerBtn.addEventListener('click', function (e) {
    ...
    burgerMenu.classList.contains('active') ? burgerMenu.style.top = "".concat(headerHeight, "px") : burgerMenu.style.top = "0px";
...
initBurgerMenu();
burgerMenu.style.top = "".concat(headerHeight, "px");
ready(function () {
  /* Variables */
  var cardFilters = document.querySelectorAll('.card-filters'),
      cardFiltersFilter = document.querySelectorAll('.card-filters__filter');
  /* Execution of functions */

  setActive(cardFilters, cardFiltersFilter);
  [].forEach.call(cardFilters, function (el, index) {
    el.classList.add('card-filter-' + index);
    var cardFiltersSwiper = new Swiper('.card-filters', {
      loop: false,
      slidesPerView: 'auto',
      spaceBetween: 4,
      allowTouchMove: true,
...
var DATA_CONTENT_MEDIA = ['Большой выбор конкурсов по прогнозам', 'Поощрим вас бонусами за активность', 'Оплатим полезные статьи деньгами'];
var DATA_CONTENT_DESKTOP = ['Для вас большой выбор \nконкурсов по прогнозам \nна спорт', 'Программа лояльности \nпоощрит вас бонусами \nза активность', 'Мы оплатим полезные статьи \nреальными деньгами: ваше мнение \nимеет значение'];
/* Variables */

var cardItem = document.querySelectorAll('.card-item');
var cardItems_flag = 1;
/* Functions */
// Set data content

var setData = function setData(arr) {
  [].forEach.call(cardItem, function (el, index) {
    var cardItemP = el.querySelector('.card-item__p');
    arr.map(function (data, dataIndex) {
      if (dataIndex === index) {
...
var setCardItemsData = function setCardItemsData(arr_1, arr_2) {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
...
var mainPost = document.querySelector('.main-post'),
...
var blogTeleport = function blogTeleport() {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
...
var footerMenuMedia = document.querySelector('.footer-menu.media-col-1'),
...
var footerTeleport = function footerTeleport() {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
